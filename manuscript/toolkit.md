...
| --- | --- | --- | --- |
| **Map** | Who receives the investment money, and who can approve the work? | Ownership, funding and decision map — see Tool 1 below | [An Investment Announcement Is Not a Budget](#announcement-is-not-a-budget), [Decide Who Decides, Before You Disagree](#decide-who-decides) |
| **Investigate** | What should we check before an investment, and how do we record what we found? | One-page technology thesis — see Tool 2 below; material finding — see Tool 3 below | [Diligence Is Your Chance to Correct the Plan Before It Is Signed](#diligence-corrects-the-plan) |
| **Compare options** | Which combination of improvements can we fund and staff at once? | Investment choices and capacity — see Tool 12 below | [You Cannot Fund Every Good Project at Once](#cannot-fund-everything) |
| **Compare options** | A financial target is driving a design proposal; which design alternative? | Valuation-to-architecture record — see Tool 11 below | [Turn “We Expect Growth” Into a Design Decision](#growth-into-design) |
| **Commit** | Can we fund and deliver this one improvement, and who is accountable? | Funded initiative record — see Tool 5 below | [The First Hundred Days: Turn Expectations Into a Funded Plan](#first-hundred-days) |
| **Obtain help** | What exactly will the adviser or specialist help us do, at what cost, for how long? | Support engagement — see Tool 4 below | [Turn an Offer of Help Into a Useful Engagement](#useful-engagement), [Find the Help That Changes What Your Team Can Do](#help-that-changes-capability) |
| **Obtain help** | Should we work with this investor at all? | Investor-fit interview — see Tool 8 below | [Judge an Investor by Their Behavior Under Pressure](#investor-under-pressure) |
| **Measure** | Did the work help, and is the benefit capacity or cash? | Outcome and contribution ledger — see Tool 6 below; small scorecard — see Tool 7 below | [The Chain From Roadmap to Revenue Breaks Easily](#roadmap-to-revenue), [Why a Cheaper Cloud Bill Can Be Bad News](#cheaper-cloud-bill) |
| **Revise or hand over** | We are combining or separating businesses; what must continue? | Integration or separation plan — see Tool 9 below | [An Acquisition Adds Work Before It Adds Value](#acquisition-adds-work-first) |
| **Revise or hand over** | Funding or ownership is changing; what evidence and obligations must travel with the work? | Funding or ownership handover — see Tool 10 below | [Hand Over the Obligations, Not Just the Company](#handover-of-obligations), [The Roadmap Did Not Slip, the Financing Did](#the-financing-slipped) |
...
{id: toolkit--stage-1-the-finding-tool-3}
...
| Kind of claim | **Observed:** in three of the five, configuration needed the same specialist’s manual work; average effort ≈ 80 hours per implementation, matching the teaching model in [The Chain From Roadmap to Revenue Breaks Easily](#roadmap-to-revenue). **Reported (Alex):** roughly 40% of the effort comes from poor customer data rather than product limitations. **Inferred (Morgan):** the dependency is structural and will not scale with more sales. **Not established:** representativeness across customer types; the actual split between data quality and product limitation. |
...
{id: toolkit--stage-2-the-options-tool-12}
...
{id: toolkit--stage-3-the-initiative-pending-and-authorized-tool-5}
...
The pending column is still useful: it is the preparation described in [The Chain From Roadmap to Revenue Breaks Easily](#roadmap-to-revenue). It does not demonstrate a funded initiative until the right column exists. The pilot is a smaller alternative to that chapter’s earlier €1 million program, not additional spending already approved alongside it.

The specialist support that helped build the setup step is a separate record (Tool 4): ten specialist days over six weeks, six days of company engineering effort, Priya accountable, an investor-side sponsor named by role, review at week six — see [Turn an Offer of Help Into a Useful Engagement](#useful-engagement).

{id: toolkit--stage-4-the-observed-result-tool-6}
...
{id: toolkit--stage-5-the-revised-decision}
...
{id: toolkit--stage-6-the-handover-entry-tool-10}
...
A new shareholder’s reporting format should not erase this entry. The original cost, the shortfall against target and the open work are the operating history the next team inherits — see [Hand Over the Obligations, Not Just the Company](#handover-of-obligations).
...
{id: toolkit--chapter-1-map-the-shareholders-funding-and-decision}
...
{id: toolkit--chapter-4-agree-an-investor-support-engagement}
## 4. Agree an Investor Support Engagement

Use when agreeing a specific source of investor support, whether a short assignment or a continuing specialist service. See [Find the Help That Changes What Your Team Can Do](#help-that-changes-capability), [Turn an Offer of Help Into a Useful Engagement](#useful-engagement) and [Is the Investor’s Adviser Helping, Assessing or Deciding?](#investors-adviser).
...
Review service cost and company effort along with satisfaction. Before extending the engagement, ask what additional useful outcome requires continued involvement. The fictional ONB-1 support in [Turn an Offer of Help Into a Useful Engagement](#useful-engagement) shows a short engagement whose week-three discovery — data quality, not the setup step, was the binding constraint — changed the scope through the agreed review.

{id: toolkit--chapter-5-build-a-funded-initiative-record}
## 5. Build a Funded Initiative Record

Use for an early operating plan or later intervention. See [The First Hundred Days: Turn Expectations Into a Funded Plan](#first-hundred-days). The pending and authorized versions of ONB-1 above show the level of detail to start with, and what has to be added before the record describes funded work.
...
{id: toolkit--chapter-7-use-a-small-outcome-scorecard}
...
{id: toolkit--chapter-8-interview-for-investor-fit}
## 8. Interview for Investor Fit

Use before and during an engagement. See [Judge an Investor by Their Behavior Under Pressure](#investor-under-pressure). Ask for evidence and concrete examples rather than assurances.
...
{id: toolkit--chapter-9-plan-acquisition-integration-or-separation}
## 9. Plan Acquisition Integration or Separation

Use alongside the transaction timetable, with appropriate legal and financial specialists. See [An Acquisition Adds Work Before It Adds Value](#acquisition-adds-work-first).
...
{id: toolkit--chapter-11-connect-valuation-to-architecture}
## 11. Connect Valuation to Architecture

Use this companion to the initiative record when a financial target is driving a technology proposal. Its main application is choosing between design alternatives under stated constraints — see [Turn “We Expect Growth” Into a Design Decision](#growth-into-design). [A Valuation Is an Estimate, Not a Fact](#valuation-is-an-estimate) supplies the financial vocabulary.
...
{id: toolkit--chapter-12-compare-investment-choices-and-capacity}
## 12. Compare Investment Choices and Capacity

Use before approving a combination of projects. See [You Cannot Fund Every Good Project at Once](#cannot-fund-everything). This record complements the individual initiative record in Tool 5: each project can be feasible on its own while the combination is not. The option rows for D-3 above are a completed example.
