...
For each transition, map the next holder of authority over the plan, the money actually available to the company, the services it depends on and the customer commitments still open. Redo the approval map from the chapter [Clarify Authority: Decide Who Decides Before You Disagree](#decide-who-decides) for the new arrangement rather than assuming the old one survives. Carry forward the original baselines and actual results. Do not reset the history because a new owner prefers a different reporting format.
...
- **[Global Private Equity Report 2026](https://www.bain.com/insights/topics/global-private-equity-report/)** — Bain & Company, 2026.  
  *Use its annual data on how long investments are held, distributions to fund investors and continuation funds to see which handover paths are common now, reading the outlook as an interested publisher’s view.*
- **[Continuation Funds: Considerations for Limited Partners and General Partners](https://ilpa.org/resources-tools/resource-library/continuation-funds-considerations-for-limited-partners-and-general-partners/)** — Institutional Limited Partners Association, 2023.  
  *It expands this chapter’s one-table treatment of continuation transactions from the side of the fund investors whose money is being moved into the new fund.*
