...
{id: learn-through-investors-network--choose-the-format-for-the-learning-you-need}
...
{id: learn-through-investors-network--build-a-community-people-can-return-to}
...
{id: learn-through-investors-network--prepare-to-learn-then-examine-what-transfers}
...
{id: learn-through-investors-network--a-fictional-team-brings-a-better-question-home}
...
{id: learn-through-investors-network--write-a-small-learning-brief}
## Write a Small Learning Brief

Use a few lines before and after the experience: **what we want to understand; who should participate; the time and cost; what we observed; what might transfer; whom we will stay in touch with; and what we will revisit next**. Leave room for surprises. [Tool 14 in the practical toolkit](#toolkit--tool-14) provides a reusable version.

The previous chapter, [Plan Investor Support: Match the Help to Company Priorities](#operating-model-blueprints), established the working arrangement with the investor. Learning through that relationship may reveal a need for more specific help. Continue with [Choose the Right Help: Compare Investor Support With Other Options](#help-that-changes-capability) to compare sources for that need, then [Set the Terms of Help: Agree the Work, Authority and Handover](#useful-engagement) to agree any assignment. [Understand Technology Operating Partners: How They Work With Your Team](#tech-operating-partner) explains how a wider investor-side team can sustain these connections; [Clarify AI Strategy: Three Different Investment Questions](#ai-strategy-three-questions) helps separate the investment decisions that an AI encounter may prompt.

{id: learn-through-investors-network--questions-to-consider}
...
The Prosus, Balderton and Insight Partners sources above describe their own learning activities. Wenger-Trayner provides the conceptual account of communities of practice. CTO Starter Kit is the author’s resource project. [Bibliography and Evidence Guide](#bibliography) records the consulted scope of S101–S105. The learning brief, format comparison and Northline example are proposed ways to reason about participation, not validated programmes or measured outcomes.
