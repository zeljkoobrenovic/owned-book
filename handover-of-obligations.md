...
> **KEY POINTS:**
>
> * **Keep the evidence during the work, not for the exit.** Baselines, actual costs, observed results and open work recorded at each review are what a buyer, a new investor or a continuing board can examine. A retrospective list of projects is not.
> * **Follow who receives cash and who keeps an interest.** A funding round, an IPO, a secondary sale of company shares, a sale of a fund interest and a continuation transaction move money and authority differently, and none is a completed fund outcome until proceeds, retained interests and dates are known.
...
[The Roadmap Did Not Slip, the Financing Did](#the-financing-slipped) ended with a dated decision record. This chapter follows such records into an ownership event, whichever form it takes. A sale is one possible event, not the inevitable next stage; the same record has to serve continued ownership, another round and a change of controlling shareholder. The Larkspur figures in this chapter are fictional and belong to the chain that runs from [Diligence Is Your Chance to Correct the Plan Before It Is Signed](#diligence-corrects-the-plan) through [The First Hundred Days: Turn Expectations Into a Funded Plan](#first-hundred-days) to this handover. The delayed-financing chapter works a deliberately separate scenario with its own cash, burn and dates; its figures are not part of this record.

{id: handover-of-obligations--keep-the-evidence-during-the-work}
## Keep the Evidence During the Work

Exit preparation is easy to describe and hard to do late. If the decision and outcome record has been kept throughout ownership, a buyer or a new investor can examine what was believed, what changed, what was invested and what remains to be done. If it has not, the company assembles a retrospective story under time pressure, and a story assembled under time pressure is exactly what a careful counterparty discounts.
...
{id: handover-of-obligations--the-larkspur-record-at-day-100}
...
{id: handover-of-obligations--avoid-exit-period-distortions}
...
A handover is accepted, not merely sent. The record lists, for each material initiative and open obligation: the baseline, the actual cost to date and the continuing cost, the observed result and its uncertainty, the open work with its funding status, and the accountable leader on both sides. The receiving decision-maker signs for it. Tool 10 in the [Practical Tools for Ownership and Technology Decisions](#toolkit) gives the format.
...
Part V has followed the company leader through investigation ([Diligence Is Your Chance to Correct the Plan Before It Is Signed](#diligence-corrects-the-plan)), the early funded plan ([The First Hundred Days: Turn Expectations Into a Funded Plan](#first-hundred-days)), a delayed financing ([The Roadmap Did Not Slip, the Financing Did](#the-financing-slipped)) and now the handover. Part VI tests these methods against company histories, starting with two contrasting exits: [PART VI — Lessons from the Field](#part-6) and [Hilton and Skype: A Successful Exit Still Needs Explaining](#hilton-and-skype).
...
{id: handover-of-obligations--to-probe-further}
## To Probe Further

- **[Global Private Equity Report 2026](https://www.bain.com/insights/topics/global-private-equity-report/)** — Bain & Company, 2026.  
  *Use its annual data on holding periods, distributions and continuation vehicles to see which handover paths are common now, reading the outlook as an interested publisher’s view.*
- **[Continuation Funds: Considerations for Limited Partners and General Partners](https://ilpa.org/resources-tools/resource-library/continuation-funds-considerations-for-limited-partners-and-general-partners/)** — Institutional Limited Partners Association, 2023.  
  *It expands this chapter’s one-table treatment of continuation transactions from the side of the fund investors whose money is being rolled.*
