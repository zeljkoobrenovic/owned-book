...
> **WHY INVESTORS CARE:** Interest, tax and working capital come out of the same cash that would fund the roadmap; an investor whose financing depends on that cash needs management to see the bridge before it commits to spending.
...
> **KEY POINTS:**
>
> * **Positive EBITDA does not establish cash available** for a new initiative. Reconcile it with investment, taxes, financing payments, working-capital needs and the cash already on hand, then check the dates and restrictions.
> * At the bridge, **separate obligations from choices**: ordinary payroll is already inside earnings; interest and repayments move only under the loan’s terms or an agreed change to them; planned investment and proposed distributions are decisions. Bring priced options with decision dates, not one unfunded request.
> * **Accounting does not remove the cost of work**, and a company spending more than it collects must decide before the runway ends. Capitalization changes when costs enter profit; the cash still leaves.

The board sees a growing measure of operating earnings. The engineering team is told there is no money for an essential migration. Both can be true, because the earnings figure has not yet been reconciled with the payments that come out of it, or with the cash the company actually holds and the dates and restrictions on that cash. Only after that reconciliation do you know how much of the earnings figure is yours to commit.

An ownership arrangement changes the conditions of that reconciliation; it does not create the gap. Acquisition borrowing adds contractual interest and repayment dates. A shareholders’ agreement may add distributions or approval thresholds. A corporate parent may set an allocation. Establish the actual payments, the authority and the dates before committing. [A Valuation Is an Estimate, Not a Fact](#valuation-is-an-estimate) distinguished earnings from cash in principle. This chapter works from earnings to the cash left after planned payments, separates the payments that are obligations from those that are choices, prices three options for one initiative, and then examines runway in a company spending more than it collects.

Before the calculation, recall **EBITDA**: earnings before interest, income taxes, depreciation and amortization, the asset-accounting charges explained in [A Valuation Is an Estimate, Not a Fact](#valuation-is-an-estimate). It leaves out several payments a business must make.
...
**The bridge is a planning calculation, not a universal payment priority.** Ordinary engineering salaries are already inside EBITDA; they are not queued behind interest. The lines below EBITDA are not all the same kind of thing. Some are obligations that move only under an agreement; some are management choices; one, owner distributions, is absent from this model and would be a proposal unless an agreement requires it.
...
| Cash interest and principal repayment | Contractual financing payments with dates | Under the loan’s terms, or through a waiver, amendment or refinancing agreed with the lender (a refinancing may bring in another lender); confirm which consents the agreement requires |
| Cash tax | A statutory obligation | Tax rules and timing, not the operating plan |
...
| Owner distributions (none in this model) | A proposal, unless a shareholders’ agreement or a preferred instrument requires them | The board and shareholders, under those agreements and the rules that apply to distributions |

The working-capital line explains why sales growth can absorb cash. Larkspur grew, so more customers owed it money at year end than at the start: about €1 million more invoiced but not yet collected. The sales are recorded, the cash isn’t in. Annual subscription prepayments work the other way and produce cash before the revenue is recognized. These timing differences can be economically helpful while still creating future service obligations.

![An earnings estimate must be reconciled with cash balances, receipts, payments and reserves before a spending commitment.](private-techuity/posts/04-obligations-before-budget/assets/images/04-obligations-before-budget/earnings-to-dated-cash-plan.jpeg)
...
The €0.5 million residual doesn’t decide the initiative. It sets the question: which version of the onboarding automation can the company fund this year, and who decides? Add three fictional assumptions to the model above. Larkspur enters the year with €0.3 million of cash above the minimum operating reserve the board treats as untouchable, so the year’s discretionary capacity is about €0.8 million if nothing else changes. The loan’s leverage covenant is tested at year end. The onboarding constraint is supported by customer evidence, as in [The Chain From Roadmap to Revenue Breaks Easily](#roadmap-to-revenue). The pilot in option 2 is the reusable setup step of that chapter, at the cost basis used there and in [Match the Funding to the Work](#raise-what-you-need): €180,000 to build in twelve engineer-weeks, €30,000 a year to maintain, and €150,000 a year for one contract implementation specialist. The annual model, the €0.3 million of opening cash and the year-end covenant test belong to this chapter alone; they are not the first-hundred-days ledger of Part V.

| Option | Additional cash this year | Engineer-weeks | Next decision date | Who decides |
| --- | ---: | ---: | --- | --- |
| 1. Minimum continuity: a contract implementation specialist for the two peak quarters, half of the €150,000 a year, and fixes for the two configuration defects that cause most rework | €75,000 | 3 | Mid-year planning review, when first-half collections are known | Ines and Sam, within the delegated annual budget |
| 2. Staged improvement: build the reusable setup step as a pilot (€180,000) and fund its first year of maintenance (€30,000), then review on the first cohort | €210,000 | 12 | Day-90 review of the first cohort of eight, counted from approval; board decision at day 100; second-stage gate at about month six | Ines approves the pilot within the delegated limit; the board decides at day 100 what the cohort result funds next and releases the second stage only at the month-six gate |
| 3. Full request: the complete €1 million automation program in one year | €1,000,000 | 36 | Board meeting before the annual budget is fixed | The board; the lender, under the covenant, if new borrowing is needed; shareholders for new equity |

**The choice.** Under these assumptions Ines approves option 2. Option 1 is rejected because it buys two quarters of capacity and leaves the dependency in place: the €75,000 recurs at the next peak, and nothing is learned about the setup step. Option 3 is rejected because it exceeds the year’s residual and the discretionary capacity before any evidence exists; funding it would mean displacing planned capital expenditure that is partly contracted, or borrowing with the lender’s consent for a benefit not yet measured. Funding: €210,000 from the year’s residual and opening cash, of which €180,000 is committed to the build at approval while the €30,000 of maintenance starts only once the step is in service; about €0.6 million of discretionary capacity is left untouched. Scarce capacity: twelve engineer-weeks and the one implementation specialist who understands the current configurations, both needed in the same two quarters. Authorized: Ines, within the delegated limit; Sam confirms the cash timing against the year-end covenant test; the board is informed at its next meeting and decides at day 100. Accountable for the pilot: Priya.

**What would change the decision.** The decision rules are the shared ones. A first cohort below 60 hours per implementation at day 90, with collections ahead of plan, would justify asking the board at day 100 to bring the second-stage decision to the mid-year review rather than the budget round; the second stage itself is released only when a cohort at about month six comes in at or below 50 hours with waiting time down. A cohort between 60 and 70 hours, with much of the remaining effort traced to customer data quality rather than the setup step, would redirect the next step to a data-quality fix before any second stage. A cohort above 70 hours, or a weak first half in collections, would fall back to option 1’s specialist for one quarter and defer the rest.

That fallback has a cash condition, and it is not a refund. By the day-90 review, on the pilot’s plan, about €90,000 of the €180,000 build will have been spent, the remaining €90,000 will be committed to the less-common customer-type templates and payable over the following two quarters, and the €30,000 of first-year maintenance will not yet have started; nothing of the build is cancellable, and only the maintenance stops if the step is withdrawn. A one-quarter specialist costs €37,500 at the same rate, which fits within the €0.6 million of discretionary capacity left after the pilot was funded. The fallback adds cost to a pilot already paid for; it does not replace the pilot with a cheaper alternative.

Pricing three options is what turns “we can’t afford €1 million” into a decision someone can take. [You Cannot Fund Every Good Project at Once](#cannot-fund-everything) extends the method to several projects competing for the same cash and the same engineer-weeks.
...
Consider a separate fictional Larkspur scenario with no acquisition debt; its cash, spending and dates belong to this scenario alone. The company has €3m of unrestricted cash and spends €600,000 a month while collecting €350,000. **Net cash burn** is the difference: €250,000 a month. At that rate, cash lasts 12 months. That estimate is its **runway**.
...
![Current cash funds work only until it is spent; delayed funding requires decisions before the runway ends.](private-techuity/posts/04-obligations-before-budget/assets/images/04-obligations-before-budget/runway-and-funding-decision.jpeg)
...
Part I has followed the money from funding to company cash. Each option above named who decides; Part II asks where that authority comes from, what an approval record looks like and what to do when the people who must agree don’t. Begin with [PART II — How Investor Ownership Changes Decisions](#part-2), then [Decide Who Decides, Before You Disagree](#decide-who-decides).
...
- **[IAS 7 Statement of Cash Flows](https://www.ifrs.org/issued-standards/list-of-standards/ias-7-statement-of-cash-flows/)** — IFRS Foundation, standard overview, undated.  
  *The standard behind a formal cash-flow statement, for moving from this chapter's simplified management bridge to the statement your finance team actually prepares.*
- **[Leveraged Loan Primer](https://pitchbook.com/leveraged-commentary-data/leveraged-loan-primer)** — PitchBook LCD (Leveraged Commentary & Data), living guide.  
  *A free introduction to floating-rate pricing, leverage ratios and covenant types, which explains the mechanics behind this chapter's covenant and floating-rate examples in more detail.*
- **[Financial Stability Report – June 2024](https://www.bankofengland.co.uk/financial-stability-report/2024/june-2024)** — Bank of England, June 2024.  
  *Section 6 on vulnerabilities in private equity gives a regulator's system-level view of the refinancing risk this chapter asks you to preserve setback capacity against.*
